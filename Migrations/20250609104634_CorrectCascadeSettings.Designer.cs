...
namespace DigitalPortalAcademy.Migrations
{
    ...
    [Migration("20250609104634_CorrectCascadeSettings")]
    partial class CorrectCascadeSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DigitalPortalAcademy.Models.Reference", b =>
                {
                    ...
                    b.HasKey("ReferenceRequestId");

                    b.ToTable("References");
                });

            modelBuilder.Entity("DigitalPortalAcademy.Models.ReferenceRequest", b =>
                {
                    b.Property<int>("ReferenceRequestId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ReferenceRequestId"));
            ...
            modelBuilder.Entity("DigitalPortalAcademy.Models.Reference", b =>
                {
                    b.HasOne("DigitalPortalAcademy.Models.ReferenceRequest", "ReferenceRequest")
                        .WithOne("Reference")
                        .HasForeignKey("DigitalPortalAcademy.Models.Reference", "ReferenceRequestId")
            ...
            modelBuilder.Entity("DigitalPortalAcademy.Models.Student", b =>
                {
                    ...
                    b.Navigation("ReferenceRequests");
                });
